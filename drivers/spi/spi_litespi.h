...
#define SPI_MOSI_DATA_REG (SPI_BASE_ADDR + 0x08)
#define SPI_MISO_DATA_REG (SPI_BASE_ADDR + 0x0C)
#define SPI_CS_REG (SPI_BASE_ADDR + 0x10)
#define SPI_LOOPBACK_REG (SPI_BASE_ADDR + 0x14)
#define SPI_CLK_DIVIDER (SPI_BASE_ADDR + 0x18)

#define POSITION_WORD_SIZE 16
